...
// 👉 ĐÃ SỬA: Thêm full_name và phone_number để gửi đủ cho Backend
export function registerAccount({ username, full_name, email, password, phone_number }) {
...
export function loginAccount({ email, password }) {
  ...
  return api.post("/auth/login", {
    username: emailTrimmed, // 👉 Đóng giả email thành username để lừa Backend
    email: emailTrimmed,
    password: String(password ?? ""),
  });
}
