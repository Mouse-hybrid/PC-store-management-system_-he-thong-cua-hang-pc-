...
import { Camera, Lock, Mail, Bell, AlertTriangle, ChevronDown } from 'lucide-react';
          ...
          <div className="space-y-5 flex-1">
            <div>
              ...
              <input 
                ...
                className="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm font-medium text-gray-800 focus:ring-2 focus:ring-blue-100 outline-none"
              />
            </div>
            <div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input 
                  type="text" name="phone" value={profile.phone} onChange={handleInputChange} placeholder="Update phone"
                  className="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm font-medium text-gray-800 focus:ring-2 focus:ring-blue-100 outline-none"
                />
              </div>
              <div>
                ...
                <div className="relative">
                  <input 
                    type="text" value={user?.role?.toUpperCase() || 'STAFF'} disabled
          ...
          <div className="bg-red-50/50 rounded-2xl border border-red-100 p-6 flex items-start gap-4">
            ...
            <div>
              ...
              <div className="flex gap-4">
                <button className="text-xs font-bold text-red-700 hover:underline">Change Password</button>
              </div>
            </div>
          </div>
        </div>
